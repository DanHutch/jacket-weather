...
class WeatherGetter {
  ...
  setBoxOne(weatherInfo) {
    ...
    box1.innerHTML = `${city}, ${state} <br>
    ${country} <br> ${formatted_date}`
  }
  ...
  //   console.log('hello dan man', time)
  //   return 'Hello'
  // }
  ...
  setBoxThree(weatherInfo) {
    ...
    hourlyBox.innerHTML = hourlyDivs;
    dailyBox.innerHTML = dailyDivs;
  }
